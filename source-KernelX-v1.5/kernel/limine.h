...
struct grub_file {
    ...
    struct grub_uuid gpt_disk_uuid;
    struct grub_uuid gpt_part_uuid;
    struct grub_uuid part_uuid;
};
...
struct grub_bootloader_info_response {
    uint64_t revision;
    LIMINE_PTR(char *) name;
    LIMINE_PTR(char *) version;
};

struct grub_bootloader_info_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct grub_bootloader_info_response *) response;
};
...
struct grub_executable_cmdline_response {
    uint64_t revision;
    LIMINE_PTR(char *) cmdline;
};

struct grub_executable_cmdline_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct grub_executable_cmdline_response *) response;
};
...
struct grub_firmware_type_response {
    uint64_t revision;
    uint64_t firmware_type;
};

struct grub_firmware_type_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct grub_firmware_type_response *) response;
};
...
struct grub_stack_size_response {
    uint64_t revision;
};

struct grub_stack_size_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct grub_stack_size_response *) response;
    uint64_t stack_size;
};
...
struct grub_hhdm_response {
    uint64_t revision;
    uint64_t offset;
};

struct grub_hhdm_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct grub_hhdm_response *) response;
};
...
struct grub_framebuffer {
    ...
    /* Response revision 1 */
    uint64_t mode_count;
    LIMINE_PTR(struct grub_video_mode **) modes;
};

struct grub_framebuffer_response {
    uint64_t revision;
    uint64_t framebuffer_count;
    LIMINE_PTR(struct grub_framebuffer **) framebuffers;
};

struct grub_framebuffer_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct grub_framebuffer_response *) response;
};
...
struct grub_flanterm_fb_init_params {
...
struct grub_flanterm_fb_init_params_response {
    uint64_t revision;
    uint64_t entry_count;
    LIMINE_PTR(struct grub_flanterm_fb_init_params **) entries;
};

struct grub_flanterm_fb_init_params_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct grub_flanterm_fb_init_params_response *) response;
};
...
struct grub_paging_mode_response {
    uint64_t revision;
    uint64_t mode;
};

struct grub_paging_mode_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct grub_paging_mode_response *) response;
    uint64_t mode;
    uint64_t max_mode;
    uint64_t min_mode;
};
...
typedef void (*grub_goto_address)(struct grub_mp_info *);
...
struct grub_mp_info {
    ...
    uint32_t lapic_id;
    uint64_t reserved;
    LIMINE_PTR(grub_goto_address) goto_address;
    uint64_t extra_argument;
};

struct grub_mp_response {
    uint64_t revision;
    uint32_t flags;
    uint32_t bsp_lapic_id;
    uint64_t cpu_count;
    LIMINE_PTR(struct grub_mp_info **) cpus;
};
...
struct grub_mp_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct grub_mp_response *) response;
    uint64_t flags;
};
...
struct grub_memmap_entry {
    uint64_t base;
    uint64_t length;
    uint64_t type;
};

struct grub_memmap_response {
    uint64_t revision;
    uint64_t entry_count;
    LIMINE_PTR(struct grub_memmap_entry **) entries;
};

struct grub_memmap_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct grub_memmap_response *) response;
};
...
typedef void (*grub_entry_point)(void);

struct grub_entry_point_response {
    uint64_t revision;
};

struct grub_entry_point_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct grub_entry_point_response *) response;
    LIMINE_PTR(grub_entry_point) entry;
};
...
struct grub_executable_file_response {
    uint64_t revision;
    LIMINE_PTR(struct grub_file *) executable_file;
};

struct grub_executable_file_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct grub_executable_file_response *) response;
};
...
struct grub_internal_module {
    LIMINE_PTR(const char *) path;
    LIMINE_PTR(const char *) string;
    uint64_t flags;
};

struct grub_module_response {
    uint64_t revision;
    uint64_t module_count;
    LIMINE_PTR(struct grub_file **) modules;
};

struct grub_module_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct grub_module_response *) response;

    /* Request revision 1 */
    uint64_t internal_module_count;
    LIMINE_PTR(struct grub_internal_module **) internal_modules;
};
...
struct grub_rsdp_response {
    uint64_t revision;
    LIMINE_PTR(void *) address;
};

struct grub_rsdp_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct grub_rsdp_response *) response;
};
...
struct grub_smbios_response {
    uint64_t revision;
    LIMINE_PTR(void *) entry_32;
    LIMINE_PTR(void *) entry_64;
};

struct grub_smbios_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct grub_smbios_response *) response;
};
...
struct grub_efi_system_table_response {
    uint64_t revision;
    LIMINE_PTR(void *) address;
};

struct grub_efi_system_table_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct grub_efi_system_table_response *) response;
};
...
struct grub_tpm_event_log_response {
    uint64_t revision;
    uint64_t format;
    uint64_t size;
    LIMINE_PTR(void *) address;
...
struct grub_tpm_event_log_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct grub_tpm_event_log_response *) response;
};
...
struct grub_efi_memmap_response {
    uint64_t revision;
...
struct grub_efi_memmap_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct grub_efi_memmap_response *) response;
};
...
struct grub_date_at_boot_response {
    uint64_t revision;
    int64_t timestamp;
};

struct grub_date_at_boot_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct grub_date_at_boot_response *) response;
};
...
struct grub_executable_address_response {
    uint64_t revision;
    uint64_t physical_base;
    uint64_t virtual_base;
};

struct grub_executable_address_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct grub_executable_address_response *) response;
};
...
struct grub_dtb_response {
    uint64_t revision;
    LIMINE_PTR(void *) dtb_ptr;
};

struct grub_dtb_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct grub_dtb_response *) response;
};
...
struct grub_riscv_bsp_hartid_response {
    uint64_t revision;
    uint64_t bsp_hartid;
};

struct grub_riscv_bsp_hartid_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct grub_riscv_bsp_hartid_response *) response;
};
...
struct grub_bootloader_performance_response {
    uint64_t revision;
    uint64_t reset_usec;
    uint64_t init_usec;
    uint64_t exec_usec;
...
struct grub_bootloader_performance_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct grub_bootloader_performance_response *) response;
};

#define LIMINE_X86_64_KEEP_IOMMU_REQUEST_ID { LIMINE_COMMON_MAGIC, 0x8ebaabe51f490179, 0x2aa86a59ffb4ab0f }

struct grub_x86_64_keep_iommu_response {
    uint64_t revision;
};

struct grub_x86_64_keep_iommu_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct grub_x86_64_keep_iommu_response *) response;
};
...
struct grub_tsc_frequency_response {
    uint64_t revision;
    uint64_t frequency;
};

struct grub_tsc_frequency_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct grub_tsc_frequency_response *) response;
};
